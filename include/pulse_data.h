...
#define PD_MAX_PULSES        300 // Maximum number of pulses before forcing End Of Package
...
#define PD_MIN_GAP_MS        15   // Minimum gap size in milliseconds to exceed to declare End Of Package
